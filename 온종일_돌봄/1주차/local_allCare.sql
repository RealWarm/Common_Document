...
create table tbl_member(
    ...
    mem_address nvarchar2(150),               /* 주소 : 한글로만 구성 */
...
create table tbl_child(
    ...
    ch_pt_id nvarchar2(50) not null UNIQUE,     /* 부모의 아이디(FK) : 영어로만 구성 */
...
create table tbl_org(
    ...
    CONSTRAINTS FK_OG_ID FOREIGN KEY(og_id)
    REFERENCES tbl_member(mem_id)
);
...
create table tbl_regist(
    ...
    reg_progress nvarchar2(50) not null,    /* 진행사항 */    
--    CONSTRAINTS FK_REG_memID FOREIGN KEY(reg_id)
--    REFERENCES tbl_member(mem_id),
--    CONSTRAINTS FK_REG_orgID FOREIGN KEY(reg_orgnum)
--    REFERENCES tbl_org(og_num)
);
...
create table tbl_bookMark(
    bmk_mem_id varchar2(50) primary key,    /* 아이디 : 영어로만 구성             복합키 */
    bmk_og_num  varchar2(50) primary key,   /* 기관 고유번호 : 영어+숫자로만 구성  복합키 */
    bmk_date date default sysdate,          /* 북마크 등록일 */
);

create table tbl_img(
    img_og_num  varchar2(50),   /* 기관번호 */
    img_og_num  varchar2(50),   /* 사진이름 */
